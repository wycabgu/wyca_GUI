...
var speedmessage;
	...
	ros.on('connection', function(){
	 ...
	 ros.on('error', function(error) {
	  ...
	  document.getElementById("outputFeedback").innerHTML="Currently in standby mode";
...
function gotoLivingroom() {
    ...
    theZ= 1.48; //0.00
	   ...
	   goal_status_listener.subscribe(function(message){
		...
		if (RposeX>=7.09 && RposeX<=7.17){
			...
			document.getElementById("outputFeedback").innerHTML="In the living room, stopping";
		}
		else {
		document.getElementById("outputFeedback").innerHTML="On the way to the living room";
		}
	});
	...
	move_base_goal_status_listener.subscribe(function(message){
		...
		if (movebaseState==4 || movebaseState==5){
			document.getElementById("outputFeedback").innerHTML="Cannot get to the living room";
		}
...
function gotoBedroom() {
    ...
    theZ= 2.41;//-4.13; //2.15; //0.63;//0.97;
	   ...
	   goal_status_listener.subscribe(function(message){
		...
		if (RposeX>=6.9 && RposeX<=7.7){
			//console.log(message.x);
			document.getElementById("outputFeedback").innerHTML="In the bedroom, stopping";
		}

		else {
		document.getElementById("outputFeedback").innerHTML="On the way to the bedroom";
		}
	});
	...
	move_base_goal_status_listener.subscribe(function(message){
		...
		if (movebaseState==2){
			document.getElementById("outputFeedback").innerHTML="Emegency stop";
		}
	...
	theZ= 1.84; //0.00
	   ...
	   goal_status_listener.subscribe(function(message){
		...
		if (RposeX>=4.85 && RposeX<=4.93){
			//console.log(message.x);
			document.getElementById("outputFeedback").innerHTML="In the dining room, stopping";
		}
		else {
		document.getElementById("outputFeedback").innerHTML="On the way to the dining room";
		}
	});
	...
	theZ= 1.61; //0.00
	   ...
	   goal_status_listener.subscribe(function(message){
		...
		if (RposeX>=3.65 && RposeX<=3.73){
			//console.log(message.x);
			document.getElementById("outputFeedback").innerHTML="Currently facing the kitchen, stopping";
		}
		else {
		document.getElementById("outputFeedback").innerHTML="On the way to the kitchen";
		}
	});
...
function gotoCharging() {
	...
	theZ= -0.06; //0.00
	   ...
	   goal_status_listener.subscribe(function(message){
		...
		if (RposeX>=8.9 && RposeX<=9.00){
			//console.log(message.x);
			document.getElementById("outputFeedback").innerHTML="At my charging point, stopping";
		}
		else {
		document.getElementById("outputFeedback").innerHTML="On the way to charge";
		}
	});
	...
	move_base_goal_status_listener.subscribe(function(message){
		...
		if (movebaseState==4 || movebaseState==5){
			document.getElementById("outputFeedback").innerHTML="Cannot get to my chargingpt";
		}
...
function moveForward(){
	document.getElementById("outputFeedback").innerHTML="Moving forward";
}

function moveBackward(){
	document.getElementById("outputFeedback").innerHTML="Moving backward";
}

function moveLeft(){
	document.getElementById("outputFeedback").innerHTML="Turning to the left";
}

function moveRight(){
	document.getElementById("outputFeedback").innerHTML="Turning to the right";
}

function releaseMove(){
	document.getElementById("outputFeedback").innerHTML="Stopped"
}
