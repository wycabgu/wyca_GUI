...
function gotoBedroom() {
	...
	move_base_goal_status_listener.subscribe(function(message){
		...
		if (movebaseState==2){
			document.getElementById("outputFeedback").innerHTML="Emegency stop because of an issue with planning";
		}
...
function moveBackward(){
	document.getElementById("outputFeedback").innerHTML="Moving backward because you pushed backward";
}

function moveLeft(){
	document.getElementById("outputFeedback").innerHTML="Turning to the left because you pushed the left";
}

function moveRight(){
	document.getElementById("outputFeedback").innerHTML="Turning to the right because you pushed right";
}
